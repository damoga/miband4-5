...
class UUIDS(object):
    ...
    # Mi Band 6
    CHARACTERISTIC_CHUNKED_TRANSFER_WRITE = '00000016-0000-3512-2118-0009af100700'
    CHARACTERISTIC_CHUNKED_TRANSFER_READ = '00000017-0000-3512-2118-0009af100700'
    CHUNKED2021_ENDPOINT_AUTH = 0x82
